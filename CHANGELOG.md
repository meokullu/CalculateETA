...
* `NameETA(double etaTime)`, `NameETAUnsafe(double etaTime)`, `NameETABetterVisual(double etaTime)`, `NameETABetterVisualUnsafe(double etaTime)` `NumberFormatETA(double etaTime)` and `NumberFormatETAUnsafe(double etaTime)`
